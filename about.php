...
<head>
    ...
    <title>About Us - DriveMate</title>
...
<body class="bg-secondary text-white">
    ...
    <section class="py-20 bg-gray-800">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-primary mb-6">About DriveMate</h1>
                <p class="text-xl text-gray-300 max-w-3xl mx-auto">
                    Your trusted partner in driving education since 2010. We've helped thousands of students become confident, skilled drivers.
                </p>
            </div>
        </div>
     <boltAction type="file" filePath="about.html">    </section>
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    <img src="https://images.unsplash.com/photo-1581593261077-c42ec8f89a16?auto=format&fit=crop&w=800&q=80" 
                         alt="Our Story" 
                ...
                <div>
                    ...
                    <p class="text-gray-300 mb-4">
                        Founded by experienced driving instructors, DriveMate was born from a vision to make driving education more accessible, comprehensive, and enjoyable.
                    </p>
                    <p class="text-gray-300 mb-4">
                        We understand that learning to drive can be challenging, which is why we've developed a unique approach that combines traditional teaching methods with modern technology.
                    </p>
    ...
    <section class="py-16 bg-gray-800">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-3xl font-bold text-primary mb-12 text-center">Our Expert Team</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Team Member 1 -->
                <div class="text-center">
                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=400&h=400&q=80" 
                         alt="John Doe" 
                         class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
                    <h3 class="text-xl font-bold mb-2">Kasun Perera</h3>
                    <p class="text-gray-400">Head Instructor</p>
                </div>
                <!-- Team Member 2 -->
                <div class="text-center">
                    <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=400&h=400&q=80" 
                         alt="Jane Smith" 
                         class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
                    <h3 class="text-xl font-bold mb-2">Mila Weerasinghe</h3>
                    <p class="text-gray-400">Senior Instructor</p>
                </div>
                <!-- Team Member 3 -->
                <div class="text-center">
                    <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&h=400&q=80" 
                         alt="Mike Johnson" 
                         class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
                    <h3 class="text-xl font-bold mb-2">Nisal Sandeepa</h3>
                    <p class="text-gray-400">Theory Specialist</p>
                </div>
            </div>
        </div>
    </section>
