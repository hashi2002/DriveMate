...
<head>
    ...
    <title>Shopping Cart - DriveMate</title>
...
<body class="bg-secondary text-white">
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4">
            <h1 class="text-4xl font-bold text-primary mb-12">Your Cart</h1>

            <!-- Cart Items -->
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2">
                    <!-- Cart Item 1 -->
                    <div class="bg-gray-800 rounded-lg p-6 mb-4 flex flex-col md:flex-row items-center gap-4">
                        <img src="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&w=150&q=80" 
                             alt="Beginner Course" 
                             class="w-24 h-24 object-cover rounded-lg">
                        <div class="flex-grow">
                            <h3 class="text-xl font-bold mb-2">Beginner's Driving Course</h3>
                            <p class="text-gray-400">Complete driving course for beginners</p>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                <button class="text-primary hover:text-primary/80 px-2 py-1">-</button>
                    ...
                    <!-- Cart Item 2 -->
                    <div class="bg-gray-800 rounded-lg p-6 mb-4 flex flex-col md:flex-row items-center gap-4">
                        <img src="https://images.unsplash.com/photo-1600320254374-ce2d293c324e?auto=format&fit=crop&w=150&q=80" 
                             alt="Test Prep" 
                             class="w-24 h-24 object-cover rounded-lg">
                        <div class="flex-grow">
                            <h3 class="text-xl font-bold mb-2">Test Preparation Package</h3>
                            <p class="text-gray-400">Complete test preparation materials</p>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                <button class="text-primary hover:text-primary/80 px-2 py-1">-</button>
                    ...
                    <!-- Cart Item 3 -->
                    <div class="bg-gray-800 rounded-lg p-6 mb-4 flex flex-col md:flex-row items-center gap-4">
                        <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=150&q=80" 
                             alt="Practical Session" 
                             class="w-24 h-24 object-cover rounded-lg">
                        <div class="flex-grow">
                            <h3 class="text-xl font-bold mb-2">2-Hour Practical Session</h3>
                            <p class="text-gray-400">One-on-one driving practice</p>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                <button class="text-primary hover:text-primary/80 px-2 py-1">-</button>
                ...
                <div class="bg-gray-800 rounded-lg p-6 h-fit">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-t border-gray-700 pt-4">
                            <div class="flex justify-between">
                                ...
                                <span class="text-primary font-bold">$590.70</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex gap-2">
                            <input type="text" 
                                   ...
                                   class="flex-grow bg-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                            <button class="bg-primary text-secondary px-4 py-2 rounded-lg font-bold hover:bg-primary/90">
                                Apply
                            </button>
                        </div>
                    </div>
                    ...
                    <!-- Checkout Button -->
                    <button class="w-full bg-primary text-secondary mt-6 py-3 rounded-lg font-bold hover:bg-primary/90 transition-colors">
                        Proceed to Checkout
                    </button>
                </div>
            </div>
