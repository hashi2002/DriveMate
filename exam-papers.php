...
<head>
    ...
    <title>Exam Papers - DriveMate</title>
...
<body class="bg-secondary text-white">
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4">
            <h1 class="text-4xl font-bold text-primary mb-12 text-center">Practice Exam Papers</h1>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Paper Set 1 -->
                <div class="bg-gray-800 p-6 rounded-lg">
                    <h3 class="text-xl font-bold mb-4">2023 Test Papers Set</h3>
                    <ul class="text-gray-400 mb-6 space-y-2">
                        <li>• 5 Full Practice Tests</li>
                ...
                <!-- Paper Set 2 -->
                <div class="bg-gray-800 p-6 rounded-lg">
                    <h3 class="text-xl font-bold mb-4">Theory Test Bundle</h3>
                    <ul class="text-gray-400 mb-6 space-y-2">
                        <li>• 10 Theory Tests</li>
                        <li>• Road Sign Practice</li>
                        <li>• Hazard Perception Tests</li>
                ...
                <!-- Paper Set 3 -->
                <div class="bg-gray-800 p-6 rounded-lg">
                    <h3 class="text-xl font-bold mb-4">Complete Study Pack</h3>
                    <ul class="text-gray-400 mb-6 space-y-2">
                        <li>• All Practice Tests</li>
                        <li>• Study Materials</li>
                        <li>• Mock Tests</li>
                        <li>• 1-on-1 Tutoring Session</li>
                    </ul>
                    <div class="flex justify-between items-center">
                        <span class="text-primary text-xl font-bold">13000LKR</span>
                        <button class="bg-primary text-secondary px-4 py-2 rounded-full font-bold hover:bg-primary/90">
                            Buy Now
                        </button>
                    </div>
