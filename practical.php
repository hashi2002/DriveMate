...
<head>
    ...
    <title>Practical Sessions - DriveMate</title>
...
<body class="bg-secondary text-white">
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4">
            <h1 class="text-4xl font-bold text-primary mb-12 text-center">Practical Driving Sessions</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-gray-800 rounded-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">2-Hour Basic Session</h3>
                        <p class="text-gray-400 mb-4">Perfect for beginners. One-on-one instruction with certified trainer.</p>
                        <div class="flex justify-between items-center">
                            <span class="text-primary text-xl font-bold">3000LKR</span>
                ...
                <div class="bg-gray-800 rounded-lg overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=800&q=80" 
                         alt="Intensive Session" 
                         class="w-full h-48 object-cover">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Intensive Course</h3>
                        <p class="text-gray-400 mb-4">5-day intensive training with multiple sessions per day.</p>
                        <div class="flex justify-between items-center">
                ...
                <!-- Session 3 -->
                <div class="bg-gray-800 rounded-lg overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&w=800&q=80" 
                         alt="Test Preparation" 
                         class="w-full h-48 object-cover">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Test Preparation</h3>
                        <p class="text-gray-400 mb-4">Mock driving test and final preparation for your license exam.</p>
                        <div class="flex justify-between items-center">
                            <span class="text-primary text-xl font-bold">4500LKR</span>
                            <button class="bg-primary text-secondary px-4 py-2 rounded-full font-bold hover:bg-primary/90">
                                Book Now
                            </button>
                        </div>
            ...
            <div class="bg-gray-800 p-8 rounded-lg">
                <h2 class="text-2xl font-bold text-primary mb-6">Book Your Session</h2>
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium mb-2">Select Date</label>
                            <input type="date" class="w-full bg-gray-700 rounded-lg p-3 text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-2">Select Time</label>
                            <select class="w-full bg-gray-700 rounded-lg p-3 text-white">
                    ...
                    <button class="w-full bg-primary text-secondary py-3 rounded-lg font-bold hover:bg-primary/90">
                        Confirm Booking
                    </button>
                </form>
            </div>
